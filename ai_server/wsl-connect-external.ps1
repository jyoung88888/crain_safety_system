...
netsh interface portproxy delete v4tov4 listenport=83 listenaddress=0.0.0.0
...
netsh interface portproxy add v4tov4 listenport=83 listenaddress=0.0.0.0 connectport=83 connectaddress=$wsl_ip
